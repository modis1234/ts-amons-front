...
const DaysDigInputCmpt = styled.div`
  width: 100%;
  height: 100%;
  .form-body {
    height: inherit;
...
const DaysDigInput = ({
  ...
  return (
    <>
      <DaysDigInputCmpt className="dig-input-component">
        <FormArea
          id="dig-form"
          submitButton={
            <FormElement
        ...
        >
          ...
          <table className="table-panel">
            ...
            <tr className="info-row row-2">
              ...
              >
                {formData.local_index
                  ? `${previewTabel?.currentLength ?? 0}m`
                  : ''}
              </td>
              <td
                className={`info-data ${formData.local_index ? '' : 'empty'}`}
