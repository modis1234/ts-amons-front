 ...
 * @return {string} * 터널명
 * */
export const getLocalType = (param) => {
 ...
 * @return {string} * 터널명
 * */
export const getTunnelName = (param) => {
...
export const getPosX = ({ posX, localType }) => {
  const _posX = posX;
 ...
 * @return {string} * 터널명
 * */
export const getLocalsOptions = (items, isAll = true) => {
 ...
 * @return {string} * 터널명
 * */
export const getGroupKindOptions = (items) => {
 ...
 * @return {string} * 용도명
 * */
export const getGroupKind = (groupKind) => {
  switch (groupKind) {
    case 0:
      return '지정안함';
    case 1:
 ...
 * */
export const getCompaniesOptions = (items) => {
...
*/
export const percentBind = (childNum, parentNum, decimalPoint = 10) => {
  if (childNum === 0) {
    return 0;
  }
...
/**
  ...
  @return {string}
 */
export const addZero = (str, digit = 3) => {
 ...
 */
export const zeroFill = (num, width) => {
  let _num = `${num} `;
...
export const sortFn = (items = [], key, oderBy = 'asc') => {
 ...
 */
export const autoHypenPhone = (string) => {
 ...
 */
export const getDiffTime = (toDate, fromDate) => {
 ...
 */
export const getDurationTime = (toDate, fromDate) => {
  const _toDate = moment(toDate);
  const _fromDate = moment(fromDate);
  const month = moment.duration(_toDate.diff(_fromDate)).months();
  const day = moment.duration(_toDate.diff(_fromDate)).days();
...
export const getDecimalPoint = (value, decimalNum = 1) => {
 ...
 */
export const birthCalculator = (birth) => {
 ...
 */
export const TransBloodGroup = (bloodGroup) => {
  switch (bloodGroup) {
    case 0:
      return '-';
    case 1:
 ...
 * @description 혈액형 변환
 */
export const TransBloodType = (bloodType) => {
  switch (bloodType) {
    case 0:
      return '-';
    case 1:
 ...
 * @description 반올림
 */
export const mathRound = (number, point = 2) => {
...
export const getProcessCode = (code) => {
  switch (code) {
    case 1:
